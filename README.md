...
Shared AP Computer Science Principles team portfolio for:

- Ruhaan Bansal — Scrum Master / Developer
...
- [SFI ideation Kanban](https://github.com/users/ruhaanb622/projects/1/views/1)
- [Kanban setup checklist](https://github.com/ruhaanb622/group-portfolio/issues/3)
...
This project uses the Open Coding Society Jekyll toolchain.

    bundle install
    make

The configured base URL is **/group-portfolio**. GitHub Pages deployment uses
the workflow in **.github/workflows/jekyll-gh-pages.yml**.

## Template credit

Created from the [Open Coding Society portfolio template](https://github.com/Open-Coding-Society/portfolio).
